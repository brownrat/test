...
if (args.munsell):
        ...
        m5bcs = np.empty((3, 4))
        print("5B4/6")
        m5bdata = c.spectral_rendering(m5b4)
        m5bcs[0][0] = m5bdata[0]
        m5bcs[1][0] = m5bdata[1]
        m5bcs[2][0] = m5bdata[2]
        print("5B5/6")
        m5bdata = c.spectral_rendering(m5b5)
        m5bcs[0][1] = m5bdata[0]
        m5bcs[1][1] = m5bdata[1]
        m5bcs[2][1] = m5bdata[2]
        print("5B6/6")
        m5bdata = c.spectral_rendering(m5b6)
        m5bcs[0][2] = m5bdata[0]
        m5bcs[1][2] = m5bdata[1]
        m5bcs[2][2] = m5bdata[2]
        print("5B7/6")
        m5bdata = c.spectral_rendering(m5b7)
        m5bcs[0][3] = m5bdata[0]
        m5bcs[1][3] = m5bdata[1]
        m5bcs[2][3] = m5bdata[2]
        ...
        # 5B vs. 10YR
        print("5B vs. 10YR")
        trial_5b = c.color_disc(m5b4, m5b5, m5b6, m5b7, m10yr5, m10yr6, m10yr7, m10yr8, correct=41, trials=64, alternative='greater')

        # 7.5B vs. 10YR
        print("7.5B vs. 10YR")
        trial_75b = c.color_disc(m75b5, m75b6, m75b7, m75b8, m10yr5, m10yr6, m10yr7, m10yr8, correct=41, trials=64, alternative='greater')

        # 5GY vs. 10YR
        print("5GY vs. 10YR")
        trial_5gy = c.color_disc(m5gy5, m5gy6, m5gy7, m5gy8, m10yr5, m10yr6, m10yr7, m10yr8, correct=41, trials=64, alternative='greater')

        # 10YR vs. 10YR, for comparison
        print("10YR vs. 10YR")
        trial_10yr = c.color_disc(m10yr5, m10yr6, m10yr7, m10yr8, m10yr5, m10yr6, m10yr7, m10yr8, correct=41, trials=64, alternative='greater')
...
if (args.mopt1):
        ...
        for i in range(w_range):
                w = args.sw + i
                median_5b[i] = c.color_disc(m5b4, m5b5, m5b6, m5b7, m10yr5, m10yr6, m10yr7, m10yr8, sw=w, output=False)[0]
        ...
        for i in range(w_range):
                w = args.sw + i
                median_75b[i] = c.color_disc(m75b5, m75b6, m75b7, m75b8, m10yr5, m10yr6, m10yr7, m10yr8, sw=w, output=False)[0]
        ...
        for i in range(w_range): xvalues[i] = i + args.sw
...
if (args.mopt2):
        ...
        for i in range(w_range):
                w = args.sw + i
                # 5GY
                values0 = c.color_disc(m5gy5, m5gy6, m5gy7, m5gy8, m10yr5, m10yr6, m10yr7, m10yr8, mw=w, output=False)
                median_5gy[i] = values0[0]
                min_5gy[i] = values0[1]
                max_5gy[i] = values0[2]
                
                print(str(w) + " nm")
                print("5GY: " + str(values0))
                ...
                # 10YR
                values1 = c.color_disc(m10yr5, m10yr6, m10yr7, m10yr8, m10yr5, m10yr6, m10yr7, m10yr8, mw=w, output=False)
                median_10yr[i] = values1[0]
                max_10yr[i] = values1[2]
                print("10YR: " + str(values1))
                if (median_10yr[i] > best_mediany):
                    best_mediany = median_10yr[i]
                    best_median = w
                if (max_10yr[i] > best_maxy):
                    best_maxy = max_10yr[i]
                    best_max = w
...
if (args.mopt3):
        ...
        lm_5gy5 = np.empty(w_range)
        lm_5gy6 = np.empty(w_range)
        lm_5gy7 = np.empty(w_range)
        lm_5gy8 = np.empty(w_range)
        for i in range(w_range):
                lm_5gy5[i] = c.spectral_rendering(m5gy5, output=False, mw=args.sw + i)[3]
                lm_5gy6[i] = c.spectral_rendering(m5gy6, output=False, mw=args.sw + i)[3]
                lm_5gy7[i] = c.spectral_rendering(m5gy7, output=False, mw=args.sw + i)[3]
                lm_5gy8[i] = c.spectral_rendering(m5gy8, output=False, mw=args.sw + i)[3]
                print(str(args.sw + i) + " nm: " + str(lm_5gy5[i]) + ", " + str(lm_5gy6[i]) + ", " + str(lm_5gy7[i]) + ", " + str(lm_5gy8[i]))
        
        print("")
        print("optimizing 10YR")
        lm_10yr5 = np.empty(w_range)
        lm_10yr6 = np.empty(w_range)
        lm_10yr7 = np.empty(w_range)
        lm_10yr8 = np.empty(w_range)
        for i in range(w_range):
                lm_10yr5[i] = c.spectral_rendering(m10yr5, output=False, mw=args.sw + i)[3]
                lm_10yr6[i] = c.spectral_rendering(m10yr6, output=False, mw=args.sw + i)[3]
                lm_10yr7[i] = c.spectral_rendering(m10yr7, output=False, mw=args.sw + i)[3]
                lm_10yr8[i] = c.spectral_rendering(m10yr8, output=False, mw=args.sw + i)[3]
